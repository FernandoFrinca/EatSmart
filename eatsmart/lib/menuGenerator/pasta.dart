...
class GenerateMenuPasta extends StatefulWidget {
  @override
  _GenerateMenuState createState() => _GenerateMenuState();
}

class _GenerateMenuState extends State<GenerateMenuPasta> {
  ...
  Future<String> _sendToChatGPT(String jsonString, String apiKey) async {
    final response = await http.post(
      ...
      body: jsonEncode({
        ...
        'messages': [
          {'role': 'system', 'content': 'Please create a pasta recipe and provide the response in the following format: Recipe Name \n\n The ingredients: -\n\n Preparation methode:'},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Generate pasta recipe'),
      ),
      body: Padding(
