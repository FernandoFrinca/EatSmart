...
class GenerateMenuSalad extends StatefulWidget {
  @override
  _GenerateMenuState createState() => _GenerateMenuState();
}

class _GenerateMenuState extends State<GenerateMenuSalad> {
  ...
  Future<String> _sendToChatGPT(String jsonString, String apiKey) async {
    final response = await http.post(
      ...
      body: jsonEncode({
        ...
        'messages': [
          {'role': 'system', 'content': 'Please create a salad and provide the response in the following format: Recipe Name \n\n The ingredients: -\n\n Preparation methode:'},
